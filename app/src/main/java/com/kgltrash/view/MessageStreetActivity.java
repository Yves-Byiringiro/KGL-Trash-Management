 ...
 */
public class MessageStreetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_message_street);

        streetsDropDown = (Spinner) findViewById(R.id.street_spinner);
        ...
        streetsDropDown.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(parent.getContext(), "Selected: " + street, Toast.LENGTH_LONG).show();
            }
            @Override
        ...
        sendMessageButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                createUser.allPhoneNumberInStreet(selectedStreet, new AllPhoneNumbersInStreet() {
                    @Override
                    public void getAllPhoneNumbersInStreet(ArrayList<String> phoneNumberList) {
