...
public class PrimaryUser extends User {
    ...
    public PrimaryUser(User user, String houseNumber_, String streetNum_)
    {
    ...
    public PrimaryUser(User user, String houseNumber_, String streetNum_, String city_)
    {
        super(user.getName(), user.getPhoneNumber(), user.getPassword(), user.getUserType(),
                user.getIsActive(), user.getCity(), user.getCode());
        houseNumber = houseNumber_;
